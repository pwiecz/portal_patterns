...
var vertexShader_gl3 string

//go:embed gl-shader/main.frag
var fragmentShader_gl3 string
...
func (renderer *OpenGL3) createDeviceObjects() {
	...
	glShaderSource(renderer.vertHandle, vertexShader_gl3)
	glShaderSource(renderer.fragHandle, fragmentShader_gl3)
...
func (renderer *OpenGL3) destroyFontsTexture() {
